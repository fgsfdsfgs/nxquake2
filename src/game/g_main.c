...
cvar_t *coop_broadcast_weapons;
cvar_t *coop_min_health;
cvar_t *coop_ammo_scale;
cvar_t *coop_exit_cooldown;
cvar_t *coop_allow_warp;
cvar_t *coop_keep_weapons;
cvar_t *coop_keep_ammo;
cvar_t *coop_keep_powerups;
cvar_t *coop_keep_armor;
cvar_t *coop_respawn_in_place;
cvar_t *dmflags;
cvar_t *skill;
cvar_t *fraglimit;
cvar_t *timelimit;
